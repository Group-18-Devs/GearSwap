...
class GearItemListFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.gear_item_list, container, false)
        ...
        if (view is RecyclerView) {
            with(view) {
                ...
                adapter = GearItemListRecyclerViewAdapter(PlaceholderContent.ITEMS)
            }
        }
        return view
    }
